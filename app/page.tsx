  ...
  return (
    <main className="min-h-screen bg-[var(--bg-main)] px-4 py-6 text-[var(--text-main)] sm:px-6 lg:px-8">
      <div className="mx-auto flex max-w-7xl flex-col gap-6">
        <header className="flex flex-col gap-4 border-b border-[rgba(255,255,255,0.12)] pb-6 lg:flex-row lg:items-end lg:justify-between">
          <div>
            <p className="font-mono text-xs uppercase tracking-[0.36em] text-[var(--text-soft)]">
              Retro Market Command Center
            </p>
            <h1 className="mt-2 bg-[linear-gradient(90deg,#ffffff,#ff8fbd,#7dd3fc)] bg-clip-text text-4xl font-black tracking-normal text-transparent sm:text-5xl">
          ...
          <div className="grid grid-cols-2 gap-3 text-xs text-[var(--text-main)]">
            <div className="rounded-xl border border-[rgba(255,255,255,0.14)] bg-[rgba(255,255,255,0.06)] p-3 shadow-[0_0_24px_rgba(255,95,162,0.12)]">
