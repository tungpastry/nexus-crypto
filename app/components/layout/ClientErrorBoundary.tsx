...
> {
  ...
  render() {
    ...
    return (
      <section className="relative overflow-hidden rounded-2xl border border-[rgba(255,255,255,0.16)] bg-[linear-gradient(180deg,rgba(255,255,255,0.08),rgba(255,255,255,0.035))] p-5 text-[var(--text-main)] shadow-[0_18px_50px_rgba(0,0,0,0.35),0_0_35px_rgba(255,95,162,0.12)]">
        ...
        <div className="relative">
          ...
          {showMessage && (
            <p className="mt-3 rounded-lg border border-[rgba(255,255,255,0.12)] bg-[rgba(0,0,0,0.35)] p-3 font-mono text-xs text-[var(--text-muted)]">
