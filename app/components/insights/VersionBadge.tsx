...
export default function VersionBadge() {
  ...
  return (
    <div className="inline-flex items-center gap-2 rounded-full border border-[var(--border-strong)] bg-[var(--bg-card)] px-3 py-1 font-mono text-xs text-[var(--text-muted)] shadow-[0_0_18px_rgba(255,95,162,0.1)]">
