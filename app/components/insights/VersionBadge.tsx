...
export default function VersionBadge() {
  ...
  return (
    <div className="inline-flex items-center gap-2 rounded-full border border-[var(--border-strong)] bg-[var(--bg-card)] px-3 py-1 font-mono text-xs text-[var(--text-muted)] shadow-[var(--version-shadow)]">
